...
class LiveThresholdGUI:
    ...
    def save_current(self):
        ...
        out_dir = self.image_path.with_suffix("").parent / f"{self.image_path.stem}_live_gui"
...
def main():
    ...
    parser.add_argument("image", help="Input image, e.g. 012-1.png")
    args = parser.parse_args()

    app = LiveThresholdGUI(Path(args.image))
    app.run()
