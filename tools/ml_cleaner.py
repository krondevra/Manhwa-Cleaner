...
OVERLAY_VARIANTS = [
    ...
    "shapes_wb",
    "shapes_ww",
    # Combined variants: black and white shapes placed together against a
    # single background color, generated by PepperNCarrotDataset's
    # src/synthesize/synthesize_shapes.py.
    "shapes_mixed_b",
    "shapes_mixed_w",
]
